...
function booth_show(element, id){
    ...
    // if($(className).hasClass("shown")){
    //     $(pinClassName).html("<img src=<%= asset_path('pins/shownpin.png') %>>");
    // }else{
    //     if(path=='day'){
    //         $(pinClassName).html("<img src=<%= asset_path('pins/pin.png') %>>");
    //     }
    //     else{
    //         $(pinClassName).html("<img src=<%= asset_path('pins/beerpin.png') %>>");
    //     }
    // }
...
function changeImage(id) {
    if ($(".pin-body_"+id).hasClass("shown")==true) {
        $("#pin_off_"+id).attr("src", "https://s3.ap-northeast-2.amazonaws.com/ajou-festival-2016/images/pins/pin.png");
    } else {
        $("#pin_off_"+id).attr("src", "https://s3.ap-northeast-2.amazonaws.com/ajou-festival-2016/images/pins/shownpin.png");
    }
}